    ...
    applicationVariants.all {
        ...
        if (isFdroid) {
            ...
            variant.outputs.map { it as com.android.build.gradle.internal.api.ApkVariantOutputImpl }.forEach { output ->
                ...
                if (versionCodes.containsKey(abi)) output.versionCodeOverride = (100 * variant.versionCode + versionCodes[abi]!!).plus(5000000) else return@forEach
            }
        } else {
            ...
            variant.outputs.map { it as com.android.build.gradle.internal.api.ApkVariantOutputImpl }.forEach { output ->
                ...
                if (versionCodes.containsKey(abi)) output.versionCodeOverride = (1000000 * versionCodes[abi]!!).plus(variant.versionCode) else return@forEach
            }
        }
    }
